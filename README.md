...
![cadastro](https://github.com/pizza2u/Biblioteca-Virtual/blob/master/-manual/CadastroNome1.png)

##### Em seguida

Tem o nível de experiência com livros/leitura, que fica de preferência do usuário colocar ou não.
![cadastro2](https://github.com/pizza2u/Biblioteca-Virtual/blob/master/-manual/CadastroNome2%20(2).png)
...
#### depois de escolhido, atribua a nota de sua preferência e aperte OK:
...
##### Essa janela será mostrada e então aperte YES:
![editarr](https://github.com/pizza2u/Biblioteca-Virtual/blob/master/-manual/EditarPrint.png)

#### O título digitado deve ser o mesmo que foi cadastrado:
...
##### Ao apertar THE END e clicar em SALVAR, você será direcionado para seus arquivos, onde poderá escolher ou criar uma pasta para salvar os livros e notas cadastradas:
...
### Carregar:
 ...
 Abra o programa e aperte no THE END e depois em CARREGAR, aparecerá seus arquivos.
 ####
